...
const AdminDash = ({ allAppointments }) => {
    ...
    useEffect(() => {
        ...
        const sortedAppointments = allAppointments.sort(
            (a, b) => timeToInteger(a.start_time) - timeToInteger(b.start_time)
        );
            ...
            <div className="even-columns">
                <div className="left">
                    ...
                    <div className="even-columns">
                        {todaysAppointments && (
                            <Chip
                                top={todaysAppointments.length}
                                middle={"Sessions Today"}
                            />
                        )}
                        <Chip
                            top={weekCount}
                            middle={"Sessions this week"}
                            percent={
                                ((weekCount - prevWeekCount) / prevWeekCount) *
                                100
                            }
                        />
                    </div>
